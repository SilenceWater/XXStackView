...
#import "SAApplicationProtcol.h"
#import <UIKit/UIKit.h>
#import <SAModuleService/SAModuleService.h>
#import <SAModuleService/SAModuleAppDelegate.h>
#import <JPush/JPUSHService.h>

@interface SAApplicationProtcol ()<SAModuleAppDelegate>

@end

@implementation SAApplicationProtcol
+ (void)load{
    [[SAModuleManager sharedInstance] registerModule:[SAApplicationProtcol class]];
}
